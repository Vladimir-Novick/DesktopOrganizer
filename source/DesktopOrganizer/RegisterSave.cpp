...
{
  strcpy(UserKeyPatch,_T("Software\\Software by Vladimir Novick\\Desktop Organaizer"));
//		char szName[60];
//		unsigned long ls=60;
...
void CRegisterSave::AutoRun(BOOL flag)
{
		...
		const char s_ValueName[] = _T("Desktop Organaizer");
...
LONG CRegisterSave::RegOpenKeyExM(
