========================================================================
    ACTIVE TEMPLATE LIBRARY : DesktopOrganizer Project Overview
========================================================================

AppWizard has created this DesktopOrganizer project for you to use as the starting point for
...
_DesktopOrganizer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_DesktopOrganizer.h)
        GUID definitions                                (_DesktopOrganizer_i.c)
        A type library                                  (_DesktopOrganizer.tlb)
        Marshaling code                                 (_DesktopOrganizer_p.c and dlldata.c)
...
StdAfx.h, StdAfx.cpp
    ...
    named DesktopOrganizer.pch and a precompiled types file named StdAfx.obj.
...
DesktopOrganizerps.vcproj
	...
	dlldata.c, DesktopOrganizer_i.c and DesktopOrganizer_p.c which are required
	to build the proxy/stub DLL.

DesktopOrganizerps.def
