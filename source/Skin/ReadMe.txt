========================================================================
    ACTIVE TEMPLATE LIBRARY : Skin Project Overview
========================================================================

AppWizard has created this Skin project for you to use as the starting point for
...
_Skin.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_Skin.h)
        GUID definitions                                (_Skin_i.c)
        A type library                                  (_Skin.tlb)
        Marshaling code                                 (_Skin_p.c and dlldata.c)
Skin.cpp
...
Skinps.vcproj
	...
	dlldata.c, Skin_i.c and Skin_p.c which are required
